                            ...
                            <div class="col-lg-8 m-auto">
                                <div class="p-5">
                                    ...
                                    <?php 
                                        ...
                                        ?>
                                        <h1 class="h4 text-gray-900 mb-4">WIUC CHURCH</h1>
                                    </div>
                                    <p class="text-center text-lg text-dark">Sign In</p>
                                    <form class="user" method="post" action="backoffice/components/login.php">
